...
import com.example.jiangtianci20171221.view.AddDeleteView;
...
public class MyAdapter1 extends BaseExpandableListAdapter {
    ...
    public MyAdapter1(Context context, List<DataBean> groupList, List<List<DataBean.ListBean>> childList) {
